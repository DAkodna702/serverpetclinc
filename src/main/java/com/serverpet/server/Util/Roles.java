...
public enum Roles {
    Administrador(Arrays.asList(Permisos.delete_users,Permisos.read_citations,Permisos.delete_citations,Permisos.update_information_all,Permisos.create_empledos)),
